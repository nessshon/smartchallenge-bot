...
from app.bot.texts import TextMessage, TextButton
...
class Manager:
    ...
    def __init__(self, emoji: str, data: Dict[str, Any]) -> None:
        ...
        self.async_session: AsyncSession = data.get("async_session")

        self.text_button = TextButton(self.user_db.language_code)
        self.text_message = TextMessage(self.user_db.language_code)
